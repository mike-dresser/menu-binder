...
class Menu(db.Model, SerializerMixin):
    ...
    serialize_only = ('id','name', 'categories.name', 'categories.id', 'categories.category_items.item.id','categories.category_items.item.name', 'categories.category_items.item.item_allergens.allergen.name','categories.category_items.item.item_allergens.allergen.id')
